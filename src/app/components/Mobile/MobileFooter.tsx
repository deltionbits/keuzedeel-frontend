        ...
        <footer className="bg-gradient-to-b from-white  to-red-100/50 row-start-3 flex gap-5 flex-wrap items-center justify-center pt-20 pb-5 -m-4 rounded-xl">
            <div className="grid grid-cols-2 grid-rows-2 gap-4 w-full">
                ...
                <div className="flex flex-col items-center">
                    <Link href="/current-games" className="font-semibold py-1 px-1 rounded hover:text-red-400 transition-colors duration-200 ease-in-out">Games</Link>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <Link href="/upcoming-games" className="font-semibold py-1 px-1 rounded hover:text-red-400 transition-colors duration-200 ease-in-out">Upcoming</Link>
                </div>
            </div>
        </footer>
    );
